 ...
 * Copyright (c) 2009-2011 by Progo, Inc. All Rights Reserved.
...
//@interface ProgoObject : NSObject
//@end

@interface ProgoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ProgoObject class]])
		{
			for (NSString *key in [[(ProgoObject*)o modules] allKeys])
			{

...
// in simulator we redefine to format for Progo Developer console
...
{\
	NSString * exceptionName = [@"org.progo." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.progo";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIProgoNativeItemNone = -1, 
	UIProgoNativeItemSpinner = -2,
	UIProgoNativeItemProgressBar = -3,
	
	UIProgoNativeItemSlider = -4,
	UIProgoNativeItemSwitch = -5,
	UIProgoNativeItemMultiButton = -6,
	UIProgoNativeItemSegmented = -7,
	
	UIProgoNativeItemTextView = -8,
	UIProgoNativeItemTextField = -9,
	UIProgoNativeItemSearchBar = -10,
	
	UIProgoNativeItemPicker = -11,
	UIProgoNativeItemDatePicker = -12,
	
	UIProgoNativeItemInfoLight = -13,
	UIProgoNativeItemInfoDark = -14,
	
	UIProgoNativeItemDisclosure = -15,
	
	UIProgoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Progo instances of
